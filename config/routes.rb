...
Rails.application.routes.draw do
  ...
  post "/confirmationcallback", to: "mpesa_apis#confirmation_callback", as: "mpesaconfirmationcallback"
  post "/validationcallback", to: "mpesa_apis#validation_callback", as: "mpesavalidationcallback"
  resources :clients
