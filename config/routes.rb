...
Rails.application.routes.draw do
  ...
  post "/mpesaconfirmationcallback", to: "mpesa_apis#confirmation_callback", as: "mpesaconfirmationcallback"
  post "/mpesavalidationcallback", to: "mpesa_apis#validation_callback", as: "mpesavalidationcallback"
  resources :clients
